<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Cliente.aspx.cs" Inherits="pSitioWEB_AlquilerV.BaseDatos.Cliente" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <table class="nav-justified">
        ...
        <tr>
            <td style="font-size: large"><strong>CATEGORIA DE LICENCIA:</strong></td>
            <td>
                    
                    <asp:DropDownList ID="cboTipoLicencia" runat="server" style="font-size: large" AutoPostBack="True">
                    </asp:DropDownList>
                    
            </td>
        </tr>
        <tr>
            <td style="font-size: large"><strong>TELEFONO:</strong></td>
            <td>
        ...
        <tr>
            <td colspan="2" class="text-left">
                <asp:GridView ID="grdCliente" runat="server" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Vertical" style="font-size: large" OnSelectedIndexChanged="grdCliente_SelectedIndexChanged" Height="154px" Width="1160px">
